    ...
    public static class Loc
    {
        ...
        static Loc()
        {
            ...
            Translations["en"] = new Dictionary<string, string> {
                ...
                {"dock_opacity", "Dock Opacity"}, {"dock_icon_size", "Dock Icon Size"},
                {"dock_length", "Dock Width"}, {"custom_size", "Custom..."},
                {"title_length", "Dock Width"}, {"prompt_length", "Enter Dock width in pixels (320 or more):"},
                {"show_clock", "Show Clock"},
                {"separate_running_apps", "Separate Running Apps"},
                {"auto_hide", "Auto-Hide"},
                {"show_media_controller", "Show Media Controller"},
                {"edit_css", "Edit Stylesheet (opendock.css)"}, {"game_mode", "Game Mode"}, {"trans_settings", "Transition Settings"},
            ...
            Translations["tr"] = new Dictionary<string, string> {
                ...
                {"dock_opacity", "Dock Opaklığı"}, {"dock_icon_size", "Dock İkon Boyutu"},
                {"dock_length", "Dock X Boyutu"}, {"custom_size", "Özel..."},
                {"title_length", "Dock X Boyutu"}, {"prompt_length", "Dock genişliğini piksel olarak girin (en az 320):"},
                {"show_clock", "Saati Göster"},
                {"separate_running_apps", "Açık Uygulamaları Ayır"},
                {"auto_hide", "Otomatik Gizle"},
                {"show_media_controller", "Medya Kontrolcüsünü Göster"},
                {"edit_css", "Stil Dosyasını Düzenle (opendock.css)"}, {"game_mode", "Oyun Modu"}, {"trans_settings", "Dönüş Ayarları"},
            ...
            Translations["es"] = new Dictionary<string, string> {
                ...
                {"separate_running_apps", "Separar aplicaciones abiertas"},
                {"auto_hide", "Ocultar automáticamente"},
                {"show_media_controller", "Mostrar controlador de medios"},
            ...
            Translations["fr"] = new Dictionary<string, string> {
                ...
                {"separate_running_apps", "Séparer les applications ouvertes"},
                {"auto_hide", "Masquer automatiquement"},
                {"show_media_controller", "Afficher le contrôleur de médias"},
            ...
            Translations["de"] = new Dictionary<string, string> {
                ...
                {"separate_running_apps", "Offene Apps trennen"},
                {"auto_hide", "Automatisch ausblenden"},
                {"show_media_controller", "Mediensteuerung anzeigen"},
